...
class backward extends Component
{
  ...
  onSubmit (){
    ...
    data['d'][0] = fx;
    if(d==1){
      ans = (this.func(parseFloat(x))-this.func(parseFloat(x)-parseFloat(h)))/parseFloat(h)
    }else if(d==2){
      ans = (this.func(parseFloat(x))-(2*this.func(parseFloat(x)-parseFloat(h)))+(this.func(parseFloat(x)-(parseFloat(h)*2))))/(Math.pow(parseFloat(h),2))
    }else if(d==3){
      ans = (this.func(parseFloat(x))-(3*this.func(parseFloat(x)-parseFloat(h)))+(3*this.func(parseFloat(x)-(parseFloat(h)*2)))-(this.func(parseFloat(x)-(parseFloat(h)*3))))/(Math.pow(parseFloat(h),3))
    }else{
      ans = (this.func(parseFloat(x))-(4*this.func(parseFloat(x)-parseFloat(h)))+(6*this.func(parseFloat(x)-(parseFloat(h)*2)))-(4*this.func(parseFloat(x)-(parseFloat(h)*3)))+(this.func(parseFloat(x)-(parseFloat(h)*4))))/(Math.pow(parseFloat(h),4))
    }
      ...
      const { size } = this.state;
        return (
          <div id="content" style={{ padding: 24, background: '#fff', minHeight: 360 }}>
            ...
            <Title style = {{textAlign: 'center'}}>Backward </Title>
            <br></br>
    ...
    <div>
    <h2 style = {{textAlign: 'center'}}>Table of Backward</h2>
