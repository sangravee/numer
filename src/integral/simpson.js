...
class simpson extends Component
{
  ...
  onSubmit (){
    ...
    var a = this.state.a;
    var b = this.state.b;
    var h = (parseFloat(b)-parseFloat(a))/3
    var itrue =0;
    var ans =0;
    var i =0;
    var error = 0;
    ...
    ans = (h/2)*(this.func(parseFloat(a))+this.func(parseFloat(b))+(4*this.func(parseFloat(a)+h)));
      ...
      const { size } = this.state;
        return (
          <div id="content" style={{ padding: 24, background: '#fff', minHeight: 360 }}>
            ...
            <Title style = {{textAlign: 'center'}}>Simpson's Rule </Title>
            <br></br>
    ...
    <div>
    <h2 style = {{textAlign: 'center'}}>Table of Simpson's Rule</h2>
