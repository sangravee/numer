...
class comsimp extends Component
{
  constructor() {
    super();
    this.state = {
  ...
  componentDidMount = async() => { 
    await api.getFunctionByName("ComSimpson").then(db => {
    this.setState({
        fx:db.data.data.fx,
        a:db.data.data.a,
        b:db.data.data.b,
  ...
  onSubmit (){
    ...
    var b = this.state.b;
    var n = this.state.n
    var h = (parseFloat(b)-parseFloat(a))/parseFloat(n);
    var hsum;
    var sum1 = 0;
    var sum2 = 0;
    var itrue =0;
    ...
    for(i=1;i<n;i++){
        if(i%2 != 0){
            sum1 = sum1 + this.func(hsum)
            console.log("h  "+hsum)
           
        }else{
            sum2 = sum2 + this.func(hsum)
            console.log("h  "+hsum)
        }
         
        hsum = parseFloat(hsum)+parseFloat(h);
    }
    ans = (h/3)*(this.func(parseFloat(a))+this.func(parseFloat(b))+(2*sum2)+(4*sum1));
    ...
    this.Graph(data['ans'])
    console.log(ans+" "+sum1+" "+sum2+" "+itrue);
  }
      ...
      const { size } = this.state;
        return (
          <div id="content" style={{ padding: 24, background: '#fff', minHeight: 360 }}>
            ...
            <Title style = {{textAlign: 'center'}}>Composite Simpson's Rule </Title>
            <br></br>
            ...
            >
              ...
              <br></br>
              <h1>n : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <Input size="large" placeholder="Input your n" name = "n"style={{ width: 500 }}
                onChange={this.onInputChange}
                />
              </h1>
              <br></br>
    ...
    <div>
    <h2 style = {{textAlign: 'center'}}>Table of Composite Simpson</h2>
    <h4 style = {{textAlign: 'center'}}> fx = {this.state.fx}
    <br></br> a = {this.state.a} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; b = {this.state.b} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; n = {this.state.n} 
